        ...
        switch (event.type) {
            ...
            case SDL_KEYDOWN:
                ...
                if (event.key.keysym.sym == SDLK_w) {
                    set_camera_pitch(get_camera_pitch() + 3.0 * delta_time);
                    break;
                }
...
void update(void) {
    ...
    for (int i = 0; i < num_faces; i++) {
        ...
        // Creating polygon from the original transformed triangle to be clipped
        ...
        // Clip the polygon and return new polygon with poential new vertices
        ...
        for (int t = 0; t < num_triangles_after_clipping; t++) {
            ...
            for (int j = 0; j < 3; j++) {
                // Project the current vertex using perspective projection matrix
...
void render(void) {
    ...
    for (int i = 0; i < num_triangles_to_render; i++) {
        ...
        if (true == render_filled_triangles()) {
        ...
        if (true == render_textured_triangles()) {
