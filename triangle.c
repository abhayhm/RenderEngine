...
//////////////////////////////////////////////////////////////////////////////////////////
// Function to draw the solid colored pixel at position x and y using depth interpolation
//////////////////////////////////////////////////////////////////////////////////////////
void draw_triangle_pixel(
    ...
    // Adjust 1/w so the pixels that are closer to camera have smaller values
    interpolated_reciprocal_w = 1.0 - interpolated_reciprocal_w;

    // Only update pixel if current pixel depth value is less than previous one stored in z-buffer
...
void draw_texel(
    ...
    // Adjusting 1/w so the pixels that are closer to camera have smaller
